...
// material-ui
import { Alert, Button, FormHelperText, Grid, InputLabel, OutlinedInput, Stack, Typography } from '@mui/material';
    ...
    <AuthWrapper>
      ...
      >
        <Grid container spacing={3}>
          ...
          {error && (
            <Grid item xs={12}>
              <Alert severity="error" sx={{ textAlign: 'center', fontWeight: 'bold', fontSize: '15px' }}>
                {error}
              </Alert>
            </Grid>
          )}
                ...
                <Formik
                  ...
                  onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                    ...
                    try {
                      ...
                      setSubmitting(false);
                      setTimeout(() => (window.location.href = '/productDraft'), 2000);
                    } catch (error) {
